        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NextOfKin = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contributions_Categories_CategoryId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, true, "Monthly Dues", "Contribution" },
                    { 2, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, true, "Special Contribution", "Contribution" },
                    { 3, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, true, "Loan", "Debt" },
                    { 4, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, true, "Penalty", "Debt" }
                });

            migrationBuilder.InsertData(
                table: "NotificationSettings",
                columns: new[] { "Id", "DayOfMonth", "DayOfWeek", "Hour", "IsEnabled", "UpdatedAt", "WeekOfMonth" },
                values: new object[] { 1, null, "Sunday", 9, true, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), 1 });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contributions_CategoryId",
                table: "Contributions",
                column: "CategoryId");
